...
var refresh = function(data) {
    ...
    svg.find("g.node:not(.transition_label)").on("mouseover", function(e) {
    ...
    svg.find("g.node:not(.transition_label)").on("click", function(e) {
    ...
    svg.find("g.node:not(.transition_label)").on("mouseout", function(e) {
